...
UUID = os.environ.get('UUID', 'd40a58f6-cdb6-48fe-a562-37181c55a139')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'streamli.134850.xyz')          # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiNGY5NGY1NmZhZDg2YzkyMWMzNDc0ZWI2Njk0NGM3YzQiLCJ0IjoiZmM0MGZjZjItZTczOS00NGIzLTk1MDUtMWQzZmE3MTM3NTZhIiwicyI6IlptSmhOalV6WldNdE5HSmlZUzAwWmprM0xXSXlaakV0WWpneFpXRmlaREpoTnpGaiJ9')              # Argo固定隧道密钥,留空即使用临时隧道
